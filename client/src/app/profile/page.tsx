...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    // Set loading to false after a brief delay for better UX
    setTimeout(() => {
      setIsLoading(false);
    }, 500);
  }, [router]);
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1">
              <Card className="text-center p-8">
                ...
                <h2 className="text-xl font-semibold mb-1">{userData.firstName} {userData.lastName}</h2>
                ...
                <div className="space-y-2">
                  <div className="border-t border-gray-200 dark:border-gray-700 pt-4 pb-2">
                    ...
                    <p className="text-2xl font-semibold text-gray-900 dark:text-white">{userData.stats?.totalNotes || 0}</p>
                  </div>
                  <div className="border-t border-gray-200 dark:border-gray-700 pt-4 pb-2">
                    <p className="text-sm text-gray-500 dark:text-gray-400">Recent Notes</p>
                    <p className="text-2xl font-semibold text-gray-900 dark:text-white">{userData.stats?.recentNotes || 0}</p>
                  </div>
                </div>
              </Card>
            </div>
